...
- 독자 확인 경로: 원문·근거의 URL(참가격 등) — 있으면 본문에 반드시 포함
...
본문은 news_editor_ij·news_editor_common과 동일하게 4문단 이상, 700~1100자 안팎으로 완결한다.
1문단: 변화·수혜자 / 2문단: 배경·문제 / 3문단: 작동 방식 / 4문단: 임팩트·남은 조건.
